...
@php
    ...
    if($order->points && $module_status) {
        $total_point_discounted = $rewardPoints->redemption($order->points);
    }
                            ...
                            <div slot="body">
                                ...
                                <div class="summary-comment-container">
                                    ...
                                    <table class="sale-summary">
                                        ...
                                        @if ($order->points && $total_point_discounted)
                                            <tr class="border">
                                                <td>{{$order->points}} Points </td>
                                                <td>-</td>
                                                <td> - {{ core()->formatBasePrice($total_point_discounted) }}</td>
                                            </tr>
