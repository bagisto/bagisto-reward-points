...
@inject ('customerRegisterReward', 'Webkul\Rewards\Helpers\CustomerRegisterHelper')
@inject('rewardModule', 'Webkul\Rewards\Helpers\ModuleHelper')

@php
    $register_points = $customerRegisterReward->getCustomerRegisterRewardPoints();
        ...
        <div class="container">
            <div class="col-lg-10 col-md-12 offset-lg-1">
                ...
                <div class="body col-12">
                    @if ($register_points && $module_status)
                    <p class="text-info"> <b>Register as a member of our family and get {{$register_points}} points</b></p>
                    @endif
                    <h3 class="fw6">
