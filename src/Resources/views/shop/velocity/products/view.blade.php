...
@php
    ...
    $rewardData = $productReward->getProductRewardPoints($product->product_id);
    $reward = 0;
    $end_date = "";
    $check = true;
    ...
    $reward = $rewardData->reward_points;
        if($rewardData->end_time){
            $end_date = \Carbon\Carbon::parse($rewardData->end_time)->format('d-M-Y H:i');
        }
    }
@endphp
                        ...
                        <div class="form-container">
                            ...
                            <div class="row">
                                ...
                                <div class="right col-lg-7 col-md-6">
                                    ...
                                    @if ($end_date && $reward )
                                        <p class="text-info"> <b> Buy This product and Get {{ $reward }} Points <br>
                                            Offer Limit Till {{ $end_date }} <b>
                                        </p>
                                    @elseif($reward > 0 )
                                        <p class="text-info"> <b> Buy This product and Get {{ $reward }} Points </b></p>
                                    @endif
