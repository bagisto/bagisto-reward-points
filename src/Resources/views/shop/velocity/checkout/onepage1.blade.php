@inject('rewardConfigRepository', 'Webkul\Rewards\Repositories\RedemptionSettingResponsitory')

@php

$applyCheck = $rewardConfigRepository->where('apply_points_checkout',1)->first();
...
@push('scripts')
    ...
    @if (auth()->guard('customer')->user() && $applyCheck )

        @include('shop::checkout.cart.points')
            ...
            <div id="checkout" class="checkout-process row offset-lg-1 col-lg-11 col-md-12">
                ...
                <div class="col-lg-7 col-md-12">
                    ...
                    <div
                        ...
                        <points-component
                            @onApplyPoints="getOrderSummary"
                            @onRemovePoints="getOrderSummary">
                        </points-component>
