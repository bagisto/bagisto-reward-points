...
@section('content')
<form method="post" action="{{route('admin.reward.product.updatecategoryspecificReward',$categoryreward->id)}}">
    <div class="content">
        ...
        <div class="page-content">
            ...
            <div class="form-container">
                ...
                <div class="control-group">
                    ...
                    <input type="datetime-local" v-validate="" class="control" id="" name="start_time" value="{{\Carbon\Carbon::parse($categoryreward->start_time)->toDateTimeLocalString()}}"
                        data-vv-as=";">
                </div>
                <div class="control-group">
                    <label for="">{{ __('rewards::app.rewards.end_date') }}</label>
                    <input type="datetime-local" v-validate="" class="control" id="" name="end_time" value="{{\Carbon\Carbon::parse($categoryreward->end_time)->toDateTimeLocalString()}}"
