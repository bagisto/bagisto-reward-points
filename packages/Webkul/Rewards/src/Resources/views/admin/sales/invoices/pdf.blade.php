            ...
            <div class="invoice-summary">
                ...
                <div class="items table">
                    <table>
                        <thead>
                            <tr>
                                <th class="table-header text-center">@lang('admin::app.sales.invoices.invoice-pdf.sku')</th>
                                <th class="table-header text-center">@lang('admin::app.sales.invoices.invoice-pdf.product-name')</th>
                                <th class="table-header text-center">@lang('admin::app.sales.invoices.invoice-pdf.price')</th>
                                <th class="table-header text-center">@lang('admin::app.sales.invoices.invoice-pdf.qty')</th>
                                <th class="table-header text-center">@lang('admin::app.sales.invoices.invoice-pdf.subtotal')</th>
                                <th class="table-header text-center">@lang('admin::app.sales.invoices.invoice-pdf.tax-amount')</th>
                                <th class="table-header text-center">@lang('admin::app.sales.invoices.invoice-pdf.grand-total')</th>
                            </tr>
                        </thead>
                ...
                <table class="sale-summary">
                    ...
                    @if (
                        ...
                        && ! empty($invoice->order->points)
                    )
                        <tr>
                            <td>@lang('rewards::app.admin.rewards.products.index.datagrid.reward-points') ({{ $invoice->order->points }})</td>
                            <td>-</td>
                            <td>{{ core()->formatBasePrice($invoice->order->points_amount) }}</td>
                        </tr>
                    @endif
