<x-admin::layouts>
    <!-- Title -->
    <x-slot:title>
        @lang('rewards::app.admin.rewards.products-specific.index.edit.title')
    </x-slot:title>
    ...
    @pushOnce('scripts')
        ...
        >
            <x-admin::form action="{{ route('admin.reward.product.update_product_specific_reward', $productReward->id) }}">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-x-2.5 items-center">
                        ...
                        <div class="flex gap-x-2.5 items-center">
                            ...
                            >
                                @lang('rewards::app.admin.rewards.products-specific.index.edit.save-btn')
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-b px-4 py-2.5 dark:border-gray-800">
                    ...
                    <div class="flex gap-4 max-sm:flex-wrap">
                        ...
                        <x-admin::form.control-group class="w-full">
                            <x-admin::form.control-group.label class="required">
                                @lang('rewards::app.admin.rewards.products.index.edit.start-date')
                            </x-admin::form.control-group.label>
                            ...
                            <x-admin::flat-picker.datetime ::allow-input="false">
                                <input
                                    type="text"
                                    name="start_time"
                                    value="{{ old($productReward->start_time) ?: $productReward->start_time }}"
                        ...
                        <x-admin::form.control-group class="w-full">
                            <x-admin::form.control-group.label class="required">
                                @lang('rewards::app.admin.rewards.products.index.edit.end-date')
                            </x-admin::form.control-group.label>
                            ...
                            <x-admin::flat-picker.datetime ::allow-input="false">
                                <input
                                    type="text"
                                    name="end_time"
                                    value="{{ old($productReward->end_time) ?: $productReward->end_time }}"
                                    class="flex min-h-[39px] w-full rounded-md border px-3 py-2 text-sm text-gray-600 transition-all hover:border-gray-400 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:border-gray-400"
                                >
                            </x-admin::flat-picker.datetime>
